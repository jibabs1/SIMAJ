...
export default function Footer({}: Props) {
  return (
    <footer className="bg-white mt-20 rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800">
      <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2021-{new Date().getFullYear()}{" "}
        <a
          href="https://trigonaltech.com"
