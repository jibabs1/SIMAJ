...
const features = [
  {
    name: "Engineering Equipment/Materials",
    description:
  ...
  {
    name: "Technical Material/Equipment",
    description:
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="sm:text-center">
          <h2 className="text-2xl font-semibold leading-8 text-[#1d7c45]">
            Services
          </h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Below are our focus area
          </p>
        ...
        <div className="mt-20 max-w-lg sm:mx-auto md:max-w-none">
          <div className="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12 md:gap-y-16">
            {features.map((feature) => (
              ...
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#1d7c45] text-white sm:shrink-0">
